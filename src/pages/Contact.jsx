    ...
    return (
        ...
        <div className="d-flex">
            ...
            style={{
                ...
                style={{ 
                    fontSize: "35px", 
                    fontWeight: "700"}}>Hubungi Kami!</span>

                <p>Anda dapat menghubungi kami melalui beberapa cara, <br/>
                    seperti melalui telepon, email, atau sosial media.</p>
